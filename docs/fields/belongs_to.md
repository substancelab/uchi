...
When opening the record selector of a BelongsTo field the records are returned in the default order defined by the repository. To do something else, pass a proc to the [`#collection_query`](#collection_query) method:
