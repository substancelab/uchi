...
Uchi Actions allows your users to perform custom tasks on your records. For example you could add an action that bans a users, marks a received comments as spam, or resends a welcome email.
