...
- The `install` generator no longer adds an unnecessary `namespace :uchi` block to `routes.rb`. It's not strictly needed and for most cases it's just fluff.
...
[0.3.1]: https://www.uchiadmin.com/releases/0.3.0
[0.3.0]: https://www.uchiadmin.com/releases/0.3.0
