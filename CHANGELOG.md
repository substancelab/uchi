...
- Repositories now support models with primary key columns not named `id`.
...
[0.4.0]: https://www.uchiadmin.com/releases/0.4.0
[0.3.1]: https://www.uchiadmin.com/releases/0.3.1
